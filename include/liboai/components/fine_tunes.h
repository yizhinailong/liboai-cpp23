    ...
    public:
        ...
        */
        LIBOAI_EXPORT liboai::Response create(
            ...
            std::optional<std::string> suffix = std::nullopt) const& noexcept(false);
        ...
        */
        LIBOAI_EXPORT liboai::Response retrieve(
            const std::string& fine_tune_id) const& noexcept(false);
        ...
        */
        LIBOAI_EXPORT liboai::Response list_events(
            ...
            std::optional<StreamCallback> stream = std::nullopt) const& noexcept(false);
        ...
        */
        LIBOAI_EXPORT liboai::Response remove(
            const std::string& model) const& noexcept(false);
